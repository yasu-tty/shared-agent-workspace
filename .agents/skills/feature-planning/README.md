...
`feature-planning` は、ファイル変更を伴う作業、複数領域にまたがる変更、仕様変更、高リスク変更、長時間かかる変更について、`plans/*.md` の実装計画を作成または更新する skill です。実装前に agreement state、scope、ownership、routing、validation、rollback を明確にするために使います。
...
- 詳細な plan 仕様の正本は `.agents/PLANS.md` です。
