...
6. Use `--force --backup` only when replacing existing files is intended.
7. Review `.agents/skills/bootstrap-agent-repo/references/POST_BOOTSTRAP_CHECKLIST.md`
8. Review `docs/agent/OWNERSHIP.md` and assign or replace placeholder roles before multi-agent work.
